...
#define ENABLE_RGB_MATRIX_PIXEL_RAIN          // Randomly light keys with random hues1
...
#undef ENABLE_RGB_MATRIX_HUE_BREATHING       // Hue shifts up mkl a slight ammount at the same time then shifts back
